...
2. **Keyword and citation search accessible anywhere**. A researcher needs to be able to survey the entire Code at once (where is this concept found) and from that initial search, to **_sort_** by relevance, location and recency; **_filter_** by _location_ (I want "resource" in the context of Title 16 - Conservation, not Title 26 - Taxes) and _status_ (current, repealed, omitted).
