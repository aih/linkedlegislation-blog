...
date: 2026-08-28T12:10:00-07:00
tags:
  - API
  - FastAPI
  - law
...
My previous post introduced my [reconception of the U.S. Code](https://blog.linkedlegislation.org/2026-08-20-the-secret-us-code-revealed/). This post 

 the United States Code ([uscode.house.gov](https://uscode.house.gov)) and my new unofficial reconception and proof of concept at [uscode.linkedlegislation.org](https://uscode.linkedlegislation.org). The site is open source (MIT license) and it is my hope that the concept, if not the software code itself, will serve as inspiration for the next official version of the Law Revision Counsel's U.S. Code site.
